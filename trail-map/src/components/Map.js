...
const MapComponent = ({ trail }) => {
  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      const pitch = 20; // Smith Rock 10, Adams Glacier 20, Angel's Rest 30, eagle creek 20, Multnomah-Wahkeena Loop 20, cape perpetua 60, battleAxeLoop 20, belknapCrater 20, Ice Lake 10, cached lake 20, Garfield Peak 10, cape falcon 30, cape kiwanda 40, cascadeHead 40
